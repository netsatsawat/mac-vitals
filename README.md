...
- **Show Menu Bar Icon** (in the `⋯` menu) is on by default. Turn it off and the app keeps recording with no icon in your way, after a short explanation of what that means. To bring the icon back, open Mac Vitals again. With the icon off and Launch at Login on, it is a quiet always-on recorder.
